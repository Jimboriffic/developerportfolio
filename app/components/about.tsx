...
export default function About() {
  ...
  return (
    <motion.section
    className="mb-28 max-w-[45rem] text-center leading-8 sm:mb-40 scroll-mt-28 border border-gray-300 rounded-lg bg-white dark:bg-gray-700 dark:border-gray-900 dark:text-rgb(31, 41, 55) shadow-lg dark:shadow-md p-8"
