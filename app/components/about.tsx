...
export default function About() {
  ...
  return (
    <motion.section
    className="mb-28 max-w-[45rem] text-center leading-8 sm:mb-40 scroll-mt-28 border border-gray-300 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-600 shadow-lgdark:shadow-md p-8"
