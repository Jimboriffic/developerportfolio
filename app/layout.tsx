  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[21.25rem] rounded-full blur-[10rem]
        sm:w-[100.75rem] dark:bg-[#946263]">
        </div>

        <div className="bg-[#dbd7fb] absolute 
        top-[-1rem] -z-10 left-[-35rem] h-[21.25rem] w-[50] rounded-full blur-[10rem]
        sm:w-[68.75rem]
